...
public struct Proof {
     ...
     */
    public var verificationLevel: Credential
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Proof {
        return
            try Proof(
                ...
                verificationLevel: FfiConverterTypeCredential.read(from: &buf)
        )
    }
...
public struct FfiConverterTypeStatus: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Status {
        ...
        case 3: return .confirmed(try FfiConverterTypeProof.read(from: &buf)
        )
        
        case 4: return .failed(try FfiConverterTypeAppError.read(from: &buf)
        )
    ...
    public static func write(_ value: Status, into buf: inout [UInt8]) {
        ...
        case let .confirmed(v1):
            writeInt(&buf, Int32(3))
            FfiConverterTypeProof.write(v1, into: &buf)
            
        
        case let .failed(v1):
            writeInt(&buf, Int32(4))
            FfiConverterTypeAppError.write(v1, into: &buf)
